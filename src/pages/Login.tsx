      ...
      >
        <div className="glass-panel rounded-2xl p-8 border-glow-blue">
          ...
          <div className="flex gap-3">
            <Button variant="outline" className="flex-1 rounded-lg border-border/50" onClick={() => handleOAuth("google")}>
            ...
            <Button variant="outline" className="flex-1 rounded-lg border-border/50" onClick={() => handleOAuth("apple")}>
