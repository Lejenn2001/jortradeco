...
const MOCK_SIGNALS: MarketSignal[] = [
  ...
  // --- Resolved mock signals ---
  {
    ...
    convictionScore: 91,
    convictionLabel: "Extreme Conviction",
    description: "$580K sweep on META $520 Calls. 14 fills. 97% ask aggression.",
    timestamp: "3/28/2026 10:15 AM",
    tags: ["Call Flow", "Sweep", "🔥 ACT NOW"],
    strike: "$520",
    expiry: "April 1, 2026",
    premium: "$580K",
    putCall: "call",
    suggestedTrade: "Buy META $520 Calls",
    entryTrigger: "Above VWAP at $515.30",
    targetZone: "$520.00 – $525.00",
    invalidation: "Below $510.00",
    keyLevel: "$515 support",
    tradeStatus: "expired",
    timeframe: "short_term",
    category: "algorithm",
    source: "live",
  ...
  },
  {
    ...
    convictionScore: 84,
    convictionLabel: "Very High Conviction",
    description: "$310K block on AMZN $195 Calls. Single print. 100% ask.",
    timestamp: "3/29/2026 11:30 AM",
    tags: ["Call Flow", "Block Trade"],
    strike: "$195",
    expiry: "April 2, 2026",
    premium: "$310K",
    putCall: "call",
    suggestedTrade: "Buy AMZN $195 Calls",
    entryTrigger: "VWAP bounce at $192.40",
    targetZone: "$195.00 – $198.00",
    invalidation: "Below $190.00",
    tradeStatus: "expired",
    timeframe: "short_term",
    category: "whale",
    source: "live",
  ...
  },
  {
    ...
    convictionScore: 76,
    convictionLabel: "High Conviction",
    description: "$220K sweep on GOOGL $165 Puts. 6 fills. 90% ask aggression.",
    timestamp: "3/30/2026 9:45 AM",
    tags: ["Put Flow", "Sweep"],
    strike: "$165",
    expiry: "April 1, 2026",
    premium: "$220K",
    putCall: "put",
    suggestedTrade: "Buy GOOGL $165 Puts",
    entryTrigger: "Break below $168.20",
    targetZone: "$165.00 – $162.00",
    invalidation: "Above $170.50",
    tradeStatus: "expired",
    timeframe: "short_term",
    category: "algorithm",
    source: "live",
  ...
  },
  {
    ...
    convictionScore: 87,
    convictionLabel: "Very High Conviction",
    description: "$1.8M sweep on AMD $125 Calls. 20 fills across 5 exchanges. 96% ask.",
    timestamp: "3/27/2026 2:10 PM",
    tags: ["Call Flow", "🔥 ACT NOW", "Sweep"],
    strike: "$125",
    expiry: "March 31, 2026",
    premium: "$1.8M",
    putCall: "call",
    suggestedTrade: "Buy AMD $125 Calls",
    entryTrigger: "Above $122.50 VWAP hold",
    targetZone: "$125.00 – $128.00",
    invalidation: "Below $120.00",
    keyLevel: "$122 support cluster",
    tradeStatus: "expired",
    timeframe: "short_term",
    category: "whale",
    source: "live",
  ...
  },
  {
    ...
    convictionScore: 79,
    convictionLabel: "High Conviction",
    description: "$400K block on MSFT $415 Puts. Bearish reversal at resistance.",
    timestamp: "3/31/2026 10:00 AM",
    tags: ["Put Flow", "Block Trade"],
    strike: "$415",
    expiry: "April 2, 2026",
    premium: "$400K",
    putCall: "put",
    suggestedTrade: "Buy MSFT $415 Puts",
    entryTrigger: "Rejection at $418.00 resistance",
    targetZone: "$415.00 – $410.00",
    invalidation: "Above $420.00",
    tradeStatus: "expired",
    timeframe: "swing",
    category: "algorithm",
    source: "live",
    ...
    <DashboardLayout>
      <div className="max-w-6xl mx-auto px-3 sm:px-4 lg:px-6 py-5 space-y-4">
        ...
        <div className="relative overflow-hidden rounded-2xl border border-border/10 bg-card/80">
          <svg className="absolute inset-0 w-full h-full opacity-[0.25]" viewBox="0 0 800 200" preserveAspectRatio="none">
            {[40, 90, 140, 190, 240, 290, 340, 390, 440, 490, 540, 590, 640, 690, 740].map((x, i) => {
              ...
              return (
                <g key={i}>
                  <line x1={x} y1={tops[i] - 15} x2={x} y2={tops[i] + heights[i] + 15} stroke={green ? "#34d399" : "#06b6d4"} strokeWidth="1.5" opacity="0.5" />
                  <rect x={x - 8} y={tops[i]} width="16" height={heights[i]} fill={green ? "#34d399" : "#06b6d4"} rx="1" opacity="0.4" />
                </g>
              );
            })}
          </svg>
          <div className="absolute inset-0 bg-gradient-to-r from-emerald-900/10 via-transparent to-cyan-900/5" />
